...
const pt = {
  ...
  journey: {
    ...
    titleHi: "evolução",
    subtitle: "Escolha uma classe, complete missões e evolua até dominar o inglês.",
    progressTitle: "Seu progresso",
    levelLabel: "Lv.",
    nextGoalLabel: "Próximo objetivo:",
    nextGoal: "Escolher sua Classe",
    rewardTitle: "Recompensa",
    quoteName: "Kai",
    quote: "Todo herói começa no nível 1. Escolha sua classe e inicie sua jornada para dominar o inglês.",
    ctaQuestion: "Pronto para sua primeira missão?",
    ctaButton: "Começar agora",
    steps: [
      { t: "Escolha sua classe", d: "Escolha entre diferentes classes e defina seu caminho de aprendizado.", rewards: ["Avatar exclusivo"] },
      { t: "Complete missões", d: "Missões diárias de vocabulário, gramática, listening e speaking para você evoluir.", rewards: ["50 Gold", "150 XP"] },
      { t: "Ganhe XP", d: "Cada missão concluída te deixa mais forte. Acumule XP e evolua!", rewards: ["Novas habilidades"] },
      { t: "Torne-se lendário", d: "Suba de nível, desbloqueie novos mundos e conquiste recompensas épicas.", rewards: ["Novos mundos", "Título exclusivo"] },
    ],
  },
...
const en: Dict = {
  ...
  journey: {
    ...
    titleHi: "evolution",
    subtitle: "Pick a class, complete missions and evolve until you master English.",
    progressTitle: "Your progress",
    levelLabel: "Lv.",
    nextGoalLabel: "Next goal:",
    nextGoal: "Choose your Class",
    rewardTitle: "Reward",
    quoteName: "Kai",
    quote: "Every hero starts at level 1. Choose your class and begin your journey to master English.",
    ctaQuestion: "Ready for your first mission?",
    ctaButton: "Start now",
    steps: [
      { t: "Choose your class", d: "Pick from different classes and define your learning path.", rewards: ["Exclusive avatar"] },
      { t: "Complete missions", d: "Daily vocabulary, grammar, listening and speaking missions to help you evolve.", rewards: ["50 Gold", "150 XP"] },
      { t: "Earn XP", d: "Every mission you complete makes you stronger. Stack XP and evolve!", rewards: ["New skills"] },
      { t: "Become legendary", d: "Level up, unlock new worlds and claim epic rewards.", rewards: ["New worlds", "Exclusive title"] },
    ],
  },
...
const es: Dict = {
  ...
  journey: {
    ...
    titleHi: "evolución",
    subtitle: "Elige una clase, completa misiones y evoluciona hasta dominar el inglés.",
    progressTitle: "Tu progreso",
    levelLabel: "Lv.",
    nextGoalLabel: "Próximo objetivo:",
    nextGoal: "Elegir tu Clase",
    rewardTitle: "Recompensa",
    quoteName: "Kai",
    quote: "Todo héroe empieza en el nivel 1. Elige tu clase e inicia tu jornada para dominar el inglés.",
    ctaQuestion: "¿Listo para tu primera misión?",
    ctaButton: "Empezar ahora",
    steps: [
      { t: "Elige tu clase", d: "Elige entre diferentes clases y define tu camino de aprendizaje.", rewards: ["Avatar exclusivo"] },
      { t: "Completa misiones", d: "Misiones diarias de vocabulario, gramática, listening y speaking para evolucionar.", rewards: ["50 Gold", "150 XP"] },
      { t: "Gana XP", d: "Cada misión completada te hace más fuerte. ¡Acumula XP y evoluciona!", rewards: ["Nuevas habilidades"] },
      { t: "Vuélvete legendario", d: "Sube de nivel, desbloquea nuevos mundos y conquista recompensas épicas.", rewards: ["Nuevos mundos", "Título exclusivo"] },
    ],
  },
